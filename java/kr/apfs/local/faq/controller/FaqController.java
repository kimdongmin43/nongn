 ...
 * @Description : FaqController.Class
...
@Controller
public class FaqController extends ComAbstractController{
	...
	public final static String  BACK_PATH = "/back/faq/";
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/back/faq/faqPageList.do")
	public ModelAndView faqPageList(ExtHtttprequestParam _req, ModelMap model) throws Exception {
        
		NavigatorInfo navigator = new NavigatorInfo(_req);	
        Map<String, Object> param  = navigator.getParam();
		navigator.setList(faqService.selectFaqPageList(param));		
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/back/faq/faqList.do")
	public @ResponseBody Map<String, Object> faqList(ExtHtttprequestParam _req, ModelMap model) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/back/faq/insertFaq.do")
    public ModelAndView insertFaq(ExtHtttprequestParam _req, ModelMap model) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/back/faq/updateFaq.do")
    public ModelAndView updateFaq(ExtHtttprequestParam _req, ModelMap model) throws Exception {
        
        int rv = 0;
        Map<String, Object> param = _req.getParameterMap();

       	try{
	       	rv = faqService.updateFaq(param);
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/back/faq/deleteFaq.do")
    public ModelAndView deleteFaq(ExtHtttprequestParam _req, ModelMap model) throws Exception {
        
       	int rv = 0;
        Map<String, Object> param = _req.getParameterMap();

       	try{
       		rv = faqService.deleteFaq(param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/back/faq/updateFaqReorder.do")
	public ModelAndView updateFaqReorder(ExtHtttprequestParam _req, ModelMap model) throws Exception {
	    
	   	int rv = 0;
	    Map<String, Object> param = _req.getParameterMap();
	    
        List<Map<String, Object>> list = (ArrayList<Map<String ,Object>>)JsonUtil.fromJsonStr(param.get("faq_list").toString().replace("&quot;","'"));
	    param.put("faq_list", list);
	   	try{
	   		rv = faqService.updateFaqReorder(param);
