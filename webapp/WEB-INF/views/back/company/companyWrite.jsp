			...
			<div class="table_area" style="margin-top:10px;padding-left:10px;padding-right:10px;">
				<table class="write">
					...
					<tr>
						...
						<td>
   						       <input class="in_w100" type="text" id="newcompRegNo" name="compRegNo" value="${companyMap.compNm}" placeholder="사업자 등록 번호" data-parsley-required="true" data-parsley-maxlength="12" readonly/>
						</td>
					...
					<tr>
						...
						<td>
					         <input class="in_w100" type="text" id="fndDate" name="fndDate" value="${companyMap.fndDate}"  placeholder="종목" data-parsley-maxlength="10"/>
						</td>
