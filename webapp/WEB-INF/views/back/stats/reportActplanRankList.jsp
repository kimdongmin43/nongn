...
<script>
var selectReportActplanRankPageListUrl = "<c:url value='/back/actplan/reportActplanRankPageList.do'/>";
...
$(document).ready(function(){
	...
	$('#apply_list').jqGrid({
		datatype: 'json',
		url: selectReportActplanRankPageListUrl,
		mtype: 'POST',
		colModel: [
			...
			{ label: '활동계획', index: 'attain_nm', name: 'attain_nm', align : 'center', sortable:false, width:100, formatter:jsNvlFormmater},
			{ label: '비율(%)', index: 'attain_rate', name: 'attain_rate', align : 'center', sortable:false, width:60, formatter:jsNvlFormmater}
		],
		postData :{	
	           year : $("#p_year").val(),
	           seq : $("#p_seq").val(),
