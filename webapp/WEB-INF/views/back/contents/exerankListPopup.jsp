...
<style>
.ui-jqgrid #sort_list tr.jqgrow td { height: 26px; padding-top: 0px;}
</style>
<script>
...
var exeRankReorderUrl = "<c:url value='/back/contents/updateExeRankReorder.do'/>";
...
<div class="search_area">
		 <table class="search_box">
			...
			<tr>
				...
				<td align="left">
					<a href="javascript:rankSearch();" class="btn sch" title="조회">
						<span>조회</span>
					</a>
				</td>
				</tr>
