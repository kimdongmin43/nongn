...
var savedRow = null;
var savedCol = null;
var selectIntropageUrl = "<c:url value='/back/contents/intropagePageList.do'/>";
...
$(document).ready(function(){
	...
	$('#intropage_list').jqGrid({
		...
		colModel: [
			...
			{ label: '콘텐츠코드', index: 'contId', name: 'contId', align : 'center', width:100 },
...
<div id="content">
	...
	<div class="table_search_area">
		<div class="float_right">
			<a href="javascript:intropageWrite('')" class="btn acti" title="추가콘텐츠 등록">
				<span>추가콘텐츠 등록</span>
			</a>
			</div>
		</div>
