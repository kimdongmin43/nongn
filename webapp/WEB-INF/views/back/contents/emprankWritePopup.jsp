...
var rankInsertUrl = "<c:url value='/back/contents/empRankInsert.do'/>";
var rankDeleteUrl = "<c:url value='/back/contents/empRankDelete.do'/>";
...
<div class="search_area" align="center" >
		 ...
		 <table class="search_box"  >
			...
			<tr>
				<th>직위명</th>
				<td>          
                  <input type="text" class="in_wp200" id="rankNm" name="rankNm" value="${empRankInfo.rankNm}"  placeholder="" data-parsley-required="true">
                  <input type = "hidden" id="rankId" name = "rankId" value = '${empRankInfo.rankId}' />
				</td>	
				</tr>
			</tbody>
		</table>	
		...
		<div class="float_right">
					<a href="javascript:rankdataInsert()" class="btn acti" title="저장">
				 	...
				 	<c:if test="${empRankInfo.rankId.toString() ne 'W' }">
					<a href="javascript:rankdataDelete()" class="btn acti" title="삭제">
						<span>삭제</span>					
					</a>
					</c:if> 
					<a href="javascript:popupClose2()" class="btn acti" title="번호저장">
						<span>취소</span>
					</a>
