...
<script>
	var IndicatorsUrl =  "<c:url value='/front/contents/chart4ListPage.do'/>";
...
<div class="content">
	...
	<div class="tab_style">
	<ul>
		<li class="w2"><a href="/front/contents/chart3ListPage.do?menuId=5367">축종별</a></li>
	...
	<div class="cont_search_area">
		<div class="cont_search_box">
			<form name="listFrm"  id="listFrm" method="post" onsubmit="return false;" onchange="changeDecember();">
				<input type="hidden" name="searchType"  id="searchType" value="608">
	...
	<div class="table_auto_area table_wrap scroll">				
		<table class="table_style_auto">
			<caption>지역별 가축재해보험 정보표로 축종,가입두수,가입농가수,가입금액,영업보험료,지급보험금,가입률 정보를 제공함</caption>
			<colgroup>
				<col width="22%" />
				<col span="6" width="13%" />
			</colgroup>
...
<script>
	...
	function excelDown(){
		if(jq){dn()};
		setTimeout("exportExcel('Chart4')",1000);
	}
	 function dn(){
	...
	//excel로 출력
	 function  exportExcel( pFileName ) {
		  ...
		  var html = "";
		  html+="<table>";
		  html+="<tr><td colspan='8' bgcolor='#ffff99'>[주석]<br><br>1. 보험사업자(농협손보, KB손보, 한화손보, DB손보, 현대해상) 제공 데이터를 기반으로 산출되었습니다.<br>";
		  ...
		  html+="<tr><td colspan='8' align='right'>(단위 : 천두, 호, 건, 백만원, ％)</td></tr>";
		  html+="</table>";
