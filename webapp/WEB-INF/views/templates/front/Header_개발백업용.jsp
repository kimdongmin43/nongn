...
function setCookie(cname, cvalue, exdays) { 
	...
	<header id="header">
		...
		<nav class="nav">
			<div class="inner">
				<h1 class="logo"><a href="/front/user/main.do"><span class="hide">농업정책보험금융원(Agricultural Policy Insurance & Finance Service)</span></a></h1>
				<!-- gnb -->
				<div id="gnb">
							...
							<div class="depth02_wrap">
								<div class="inner">
									<div class="list">
										...
										<ul class="depth02">
											<li>
												...
												<ul class="depth03">
													...
													<li><a href="javascript:goSubMenu('http://agrocrowd.kr/','5323','undefined','///');" title="농식품 크라우드펀딩 전용관 바로가기">농식품 크라우드펀딩 전용관&nbsp;<img src="/images/common/ico_new_win.png" alt="농식품 크라우드펀딩 전용관 바로가기 새창열림"></a></li>
												</ul>
											</li>
										</ul>
										<ul class="depth02">
										...
										<ul class="depth02">
											<li>
												<a href="https://assist.apfs.kr" target="_blank" title="ASSIST(농식품 투자정보 플랫폼) 새 창 열림">ASSIST<br />(농식품 투자정보 플랫폼) <img src="/images/common/ico_new_win.png" alt="ASSIST(농식품 투자정보 플랫폼) 바로가기 새창열림"></a>
											</li>
										</ul>
										<!-- //20210408 -->
										<ul class="depth02">
				...
				<div class="utile_allmenu">
					<a href="javascript:void(0);" class="header_search" alt="통합검색하기">통합검색하기</a>
					<!-- 검색박스 -->
					<div class="header_search_box">
							<div class="inner">
								...
								<a href="javascript:void(0);" class="search_close" alt="통합검색 닫기"><span class="hide">통합검색 닫기</span></a>
							</div>
					</div>
					<!-- //검색박스 -->
					<a href="javascript:void(0);" class="allmenu_open" alt="전체메뉴">전체메뉴</a>
					<!-- 전체메뉴 -->
					<div class="allmenu">
						<div class="inner">
							<div class="allmenu_title">전체메뉴</div>
							<c:import url = "/WEB-INF/views/front/user/inc/allMenu.jsp"/>
							<a href="javascript:void(0);" class="allmenu_close" data-focus="allmenu_focus01" data-focus-next="allmenu_focus01" alt="전체메뉴닫기"><span class="hide">전체메뉴닫기</span></a>
						</div>
					</div>
					<!-- //전체메뉴 -->
				</div>
